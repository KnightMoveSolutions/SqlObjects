...
{
    public class FluentApi_Case_IsLessThanOrEqualTo_Tests
    {
        private readonly string NL = Environment.NewLine;

        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_String()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Column()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    .CASE(returnType: SqlDbType.VarChar)
                      ...
                      .ELSE("t", "ColumnC")
                    .END().IsLessThanOrEqualTo("t", "OtherColumn");
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Int()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_DateTime()
        {
            // ARRANGE
                ...
                TSQL
                  ...
                  .WHERE()
                    .CASE(returnType: SqlDbType.DateTime)
                      ...
                      .ELSE(TOMORROW)
                    .END().IsLessThanOrEqualTo(TEST_DATE);
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Bool()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Long()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    .CASE(returnType: SqlDbType.BigInt)
                      ...
                      .ELSE(long.MinValue)
                    .END().IsLessThanOrEqualTo(long.MaxValue);
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Guid()
        {
            // ARRANGE
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Char()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsLessThanOrEqualTo_Decimal()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    ...
                    .END().IsLessThanOrEqualTo(decimal.MaxValue);
