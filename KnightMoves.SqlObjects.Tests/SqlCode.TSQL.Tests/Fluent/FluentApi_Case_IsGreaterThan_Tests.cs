...
{
    public class FluentApi_Case_IsGreaterThan_Tests
    {
        private readonly string NL = Environment.NewLine;

        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_String()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Column()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    .CASE(returnType: SqlDbType.VarChar)
                      ...
                      .ELSE("t", "ColumnC")
                    .END().IsGreaterThan("t", "OtherColumn");
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Int()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_DateTime()
        {
            // ARRANGE
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Bool()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Long()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    .CASE(returnType: SqlDbType.BigInt)
                      ...
                      .ELSE(long.MinValue)
                    .END().IsGreaterThan(long.MaxValue);
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Guid()
        {
            // ARRANGE
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Char()
        {
            // ARRANGE
            var sqlObj =
                TSQL
        ...
        [Fact]
        public void Select_Star_From_Where_Case_IsGreaterThan_Decimal()
        {
            // ARRANGE
            var sqlObj =
                TSQL
                  ...
                  .WHERE()
                    ...
                    .END().IsGreaterThan(decimal.MaxValue);
