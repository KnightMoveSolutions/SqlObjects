...
{
    public enum TSQLFuncMaxParams { aggregateExpression }

    /// <summary>
    /// Implements the creation of the SQL Max function
    /// </summary>
    public class TSQLFuncMax : TSQLStatement, ISqlFunctionMax
    {
        /// <summary>
        ...
        public void SetParameterValue(TSQLFuncMaxParams paramName, ISqlQueryExpression paramValue) => SetParameterValue(paramName.ToString(), paramValue);
        ...
        public TSQLFuncMax()
        {
            ...
            Parameters.Add(new TSQLParameter
            {
                ...
                ParameterDescription = "An expression that represents a set of values to be examined for its maximum value.  A 'Column' is the most likely type of expression.",
        ...
        /// <summary>
        /// <para>
        /// Produces a T-SQL Max function call that uses the 'expression' parameter from the 
