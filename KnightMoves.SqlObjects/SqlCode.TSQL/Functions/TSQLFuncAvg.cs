...
public enum TSQLFuncAvgParams { aggregateExpression }

/// <summary>
/// Implements the creation of the SQL mathematical Average function
/// </summary>
public class TSQLFuncAvg : TSQLStatement, ISqlFunctionAvg
{
    /// <summary>
    ...
    public void SetParameterValue(TSQLFuncAvgParams paramName, ISqlQueryExpression paramValue) => SetParameterValue(paramName.ToString(), paramValue);
    ...
    public TSQLFuncAvg()
    {
        ...
        Parameters.Add(new TSQLParameter
        {
            ...
            ParameterDescription = "An expression that represents a set of values to be averaged.  A 'Column' is the most likely type of expression.",
